                            ...
                            <>
                                {showLogin ?
                                    ...
                                    <Form onSubmit={handleRegister}>
                                        {/*<div className="logo" style={{marginBottom : "20px"}}>*/}
                                        {/*    <img className="img-login" style={{width: "200px", height: "200px"}} src={Register}/>*/}
                                        {/*</div>*/}
                                        <h1 style={{textAlign: "center", fontWeight: "bold", color: "#17d2bb", marginBottom: "30px"}}>REGISTER</h1>
                                        <Form.Group className="mb-3" controlId="formBasic">
                                            <Form.Label>User-name</Form.Label>
                                            <Form.Control
                                                required
